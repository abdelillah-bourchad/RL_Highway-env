...
models_dir = f"models_gamma{int(100*gamma)}_{policy}_col{collision_reward}_arr{arrived_reward}_spd{high_speed_reward}/A2C"
...
model = A2C(policy, env, verbose=2, tensorboard_log=logdir
            , gamma=gamma)
